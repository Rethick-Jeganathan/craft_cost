  ...
  return (
    <div className="mx-auto max-w-3xl min-h-[70vh] flex flex-col items-center justify-center text-center">
      <div className="mb-4 inline-flex items-center gap-2">
        ...
        <span className="text-sm font-semibold text-[var(--text)] opacity-80">craft_cost</span>
      </div>

      <h1 className="text-[2.25rem] leading-tight font-semibold text-[var(--text)] opacity-90">Spend better. Simple financial clarity.</h1>
      ...
      <div className="mt-5 w-full">
        <div className="rounded-2xl p-[1.5px] bg-gradient-to-br from-brand-600/25 via-transparent to-white/10">
          <div className="flex items-center gap-3 rounded-2xl bg-[rgba(3,7,18,0.6)] px-4 py-3 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
            ...
            />
            <a href="/upload" className="rounded-md border border-[var(--border)]/60 bg-brand-600/15 px-3 py-1.5 text-xs font-medium text-[var(--text)] hover:bg-brand-600/25">
              Upload CSV
            </a>
            {plaidEnabled && (
              <Button
